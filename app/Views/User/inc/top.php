...
<head>
    ...
    <!-- Favicon -->
    <link href="<?= base_url('assets/user/img/favicon.html') ?>" rel="icon">
    ...
    <link href="<?= base_url('assets/user/cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css') ?>" rel="stylesheet">
    <link href="<?= base_url('assets/user/cdn.jsdelivr.net/npm/bootstrap-icons%401.4.1/font/bootstrap-icons.css') ?>" rel="stylesheet">

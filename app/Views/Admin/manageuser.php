            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tbody>
                  <?php foreach ($applicants as $appsi): ?>
                                            <?php if ($appsi['stat'] != "Cancelled") { ?>
                                            <tr>
                                            <td><?= $appsi['full_name'] ?></td>
                                                <td><?= $appsi['status'] ?></td>
                                                <td><?= $appsi['category'] ?></td>
                                                <td><?= $appsi['contact_number'] ?></td>
                                                <td><?= $appsi['address'] ?></td>
                                                <td><?= $appsi['email'] ?></td>
                                                <td><?= $appsi['stat'] ?></td>
                            
                                                <td><a href="#" class="btn btn-dark">Block</a></td>
